...
### 3. Android-first geofencing and NFC
...
### 4. Release controls, audit hardening, and readiness
...
- Audit trail captures queue, delegation, verification, and release changes.
...
Next up is Milestone 3: implement Android geofencing and NFC so approaching and verified states can be driven by live device events.
